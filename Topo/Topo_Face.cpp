...
void Topo_Face::Triangulate(double dDeviation, void (*pRet)(const Geom_Vec3&pnt))
{
    //TODO: check that current type is planar. Run completely different algorithm if it is not
...
void *Topo_Face::MakeTranslatedCopy(Geom_Vec3 dir) const
{
    Topo_Face *nface = new Topo_Face(this);
